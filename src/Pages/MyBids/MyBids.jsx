    ...
    <>
      ...
      <section className="min-h-[calc(100vh-304px)] max-w-screen-2xl mx-auto px-4 py-12">
        <div className="flex items-center gap-x-3">
          <h2 className="text-xl font-bold text-gray-700">My Bids</h2>
                      ...
                      <tr key={bid._id}>
                        ...
                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                          ...
                          <button
                            ...
                            title="Mark Complete"
                            className="btn transition-colors duration-200  border-none hover:bg-green-600 bg-green-500 focus:outline-none disabled:cursor-not-allowed"
                          >
                            <svg
